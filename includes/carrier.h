...
public:
    Carrier(const std::string &name = CarrierConstants::CARRIER_NAME, int healthPoints = CarrierConstants::CARRIER_HEALTH, int damage = CarrierConstants::CARRIER_DAMAGE, int shield = CarrierConstants::CARRIER_SHIELD, int numberOfInterceptors = CarrierConstants::CARRIER_MAX_INTERCEPTORS);
